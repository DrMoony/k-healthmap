...
const SCEN = [
  { k: 'low', lab: '지역센터급 2.5억/년', note: '지역심뇌혈관질환센터 총사업비, 국비 1.25억 (복지부 공고 제2024-816호·제2025-922호) — 본 확충안의 기본 시나리오' },
  { k: 'base', lab: '24시간 진료체계 5억/년', note: '권역센터 전문진료체계 사업비, 국비 2.5억 (복지부 「2024년 권역심뇌혈관질환센터 운영지침」 — 5억 중 2.5억 이상을 당직수당·24시간 추가인력 인건비에 편성하도록 명시)' },
  { k: 'high', lab: '권역 총사업비 12억/년', note: '권역센터 전체 운영비, 국비 6억 = 전문진료 2.5 + 예방관리 3.5 (같은 운영지침). 혈전제거 시술 포함 규모라 tPA 승격에는 과대' },
];
