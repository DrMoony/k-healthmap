...
const DISEASES = {
  obesity: {
    ...
    comorbidity: '당뇨 OR 5.2, 고혈압 OR 2.1, 이상지질혈증 OR 1.9 (KOSSO 2024)',
    color: '#ff006e',
    pathway: 'root',
    populationEn: '~15.8M',
    ...
    comorbidityEn: 'DM OR 5.2, HTN OR 2.1, Dyslipidemia OR 1.9 (KOSSO 2024)',
  ...
  diabetes: {
    ...
    level: 1, prevalence: '15.5%', population: '약 530만명 (30세 이상)',
    trend: '2005년 6.7% → 2022년 15.5% (꾸준히 증가)',
  ...
  dyslipidemia: {
    ...
    level: 1, prevalence: '48.4%', population: '약 1,780만명',
    trend: '2005년 41.3% → 2022년 48.4% (꾸준히 증가)',
  ...
  heart_failure: {
    ...
    level: 2, prevalence: '3.41%', population: '약 175만명',
    trend: '2002년 0.77% → 2023년 3.41% (4.4배)',
    riskFactors: ['고혈압', '당뇨', '허혈성심질환', '심방세동', '비만'],
    description: '심장 펌프 기능 부전. 유병률 4.4배 증가, 의료비 3.2조원. 입원 사망률 17%.',
    comorbidity: '고혈압 77.9%, 당뇨 65.5%, 허혈성심질환 50.9%',
    color: '#e91e63', pathway: 'cardiac',
    populationEn: '~1.75M',
    trendEn: '0.77% (2002) → 3.41% (2023), ×4.4',
    descriptionEn: 'Cardiac pump failure. Prevalence ×4.4 increase. In-hospital mortality 17%.',
    comorbidityEn: 'HTN 77.9%, DM 65.5%, IHD 50.9%',
