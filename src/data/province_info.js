...
// KOSIS 심뇌혈관질환통계(2023) 허혈성 뇌졸중 환자수
...
export const PROVINCE_INFO = {
  "서울": {
    ...
    strokeIncidence: 101.6, strokeMortality: 28.5, tpaRate: 12.3, goldenTimeRate: 52,
    strokePatients2023: 21138,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "부산": {
    ...
    strokeIncidence: 125.3, strokeMortality: 35.2, tpaRate: 8.5, goldenTimeRate: 42,
    strokePatients2023: 5798,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "대구": {
    ...
    strokeIncidence: 118.7, strokeMortality: 33.1, tpaRate: 9.8, goldenTimeRate: 44,
    strokePatients2023: 5103,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "인천": {
    ...
    strokeIncidence: 112.4, strokeMortality: 31.5, tpaRate: 10.2, goldenTimeRate: 45,
    strokePatients2023: 5969,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "광주": {
    ...
    strokeIncidence: 115.8, strokeMortality: 30.8, tpaRate: 14.9, goldenTimeRate: 48,
    strokePatients2023: 3287,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "대전": {
    ...
    strokeIncidence: 108.5, strokeMortality: 29.2, tpaRate: 11.5, goldenTimeRate: 47,
    strokePatients2023: 4014,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "울산": {
    ...
    strokeIncidence: 120.1, strokeMortality: 32.5, tpaRate: 7.8, goldenTimeRate: 40,
    strokePatients2023: 1858,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "세종": {
    ...
    strokeIncidence: 104.8, strokeMortality: 27.5, tpaRate: 6.5, goldenTimeRate: 35,
    strokePatients2023: 490,  // KOSIS 허혈성 뇌졸중 환자수
    tertiaryList: [],
  },
  "경기": {
    ...
    strokeIncidence: 110.2, strokeMortality: 30.1, tpaRate: 9.5, goldenTimeRate: 43,
    strokePatients2023: 24243,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "강원": {
    ...
    strokeIncidence: 128.5, strokeMortality: 38.2, tpaRate: 6.2, goldenTimeRate: 28,
    strokePatients2023: 4173,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "충북": {
    ...
    strokeIncidence: 131.2, strokeMortality: 37.5, tpaRate: 7.1, goldenTimeRate: 30,
    strokePatients2023: 3054,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "충남": {
    ...
    strokeIncidence: 126.8, strokeMortality: 36.8, tpaRate: 7.5, goldenTimeRate: 32,
    strokePatients2023: 3193,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "전북": {
    ...
    strokeIncidence: 134.5, strokeMortality: 39.1, tpaRate: 8.2, goldenTimeRate: 31,
    strokePatients2023: 5638,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "전남": {
    ...
    strokeIncidence: 130.2, strokeMortality: 40.5, tpaRate: 6.8, goldenTimeRate: 25,
    strokePatients2023: 2404,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "경북": {
    ...
    strokeIncidence: 127.3, strokeMortality: 38.8, tpaRate: 4.6, goldenTimeRate: 26,
    strokePatients2023: 3703,  // KOSIS 허혈성 뇌졸중 환자수
    tertiaryList: [],
  },
  "경남": {
    ...
    strokeIncidence: 122.5, strokeMortality: 34.5, tpaRate: 7.9, goldenTimeRate: 35,
    strokePatients2023: 4446,  // KOSIS 허혈성 뇌졸중 환자수
  ...
  "제주": {
    ...
    strokeIncidence: 119.8, strokeMortality: 33.8, tpaRate: 8.0, goldenTimeRate: 33,
    strokePatients2023: 1577,  // KOSIS 허혈성 뇌졸중 환자수
    tertiaryList: [],
  },
};
